public class Registers {
    ...
    int cc, r0, r1, r2, r3, ir, mar, mbr, mfr, msr, pc, x1, x2, x3, fr0, fr1;
    ...
    public String getBinaryStringIr() {
        try {
            // Assuming this.ir is an octal number incorrectly stored as decimal
    ...
    public void increasePCByOne() {
        if(FrontPanel.anInt2 <FrontPanel.arrayList.size()){
            this.pc=FrontPanel.arrayList.get(FrontPanel.anInt2);
            FrontPanel.anInt2++;
        }
    }
